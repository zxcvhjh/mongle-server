...
import
    com.algangi.mongle.comment.domain.model.Comment;
...
public final class CommentResponseMapper {
    ...
    private static final String MASKED_CONTENT_DELETED = "삭제된 댓글입니다.";
    private static final String MASKED_CONTENT_BLOCKED = "신고로 인해 블라인드 된 댓글입니다.";
    private static final String MASKED_NICKNAME = "(알 수 없음)";
    private static final String
        ANONYMOUS_NICKNAME = "익명의 몽글러";
    ...
    public CommentInfoResponse toCommentInfoResponse(
        ...
        AuthorInfoResponse authorInfo =
            mapAuthor(author, isDeleted, isAnonymous);
    ...
    private String mapContent(Comment comment, boolean deleted) {
        ...
        if (status == CommentStatus.BLOCKED_BY_REPORTS) {
            return MASKED_CONTENT_BLOCKED;
        }

        return MASKED_CONTENT_DELETED;
    }
